...
> 2. **iOS**: v180-182 は web のみ＝native 契約不変（次の 1.5 ビルドに自動で乗る）。TestFlight 1.5(42) の確認事項は下のセッション31参照（🎞️カメラ WKWebView・カメラロール保存・Quick Action・BUILD が phase3.130 未満なら新ビルド）。
