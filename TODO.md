...
> - **▶ 次の一手**: ①（習慣）Gmail で **1.3(34) の審査結果**を確認（[[session-start-gmail-check]]）→承認なら公開可否をユーザーに確認→公開＝café ヒーロー版デビュー。②**Android を Google Play へ**（位置入り v150・[[post-launch-roadmap]]／[[madeleine-product-repo]]）。③v152 ほか web 改善は次ビルドで iOS/Android に。
>
