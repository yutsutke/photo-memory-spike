...
> - **状態**: native=**1.1(26) リリース済（配信準備完了・ex-EU 148地域）**／1.0(21) から差し替わり／web=GitHub Pages `phase3.92`（v139 まで）。1.2 は未ビルド（v138-139 は push 済・要 Codemagic トリガー）。
>
