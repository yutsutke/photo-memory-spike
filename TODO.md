...
> - **v166+（UI整理・同セッション・ユーザーFB）**: ①基準日の設定を⚙設定へ移動（ログの基準日バー撤去）②名前はチップ撤去→題名の横の✎だけ（アクション行3ボタンに）。preview green。詳細 CHANGELOG v166 追記。**実機の手触り（web＋次の1.5ビルド）が次**。
