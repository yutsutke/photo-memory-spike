...
| アプリアイコン | ✅ **2026-08-18 差し替え** | 暗い背景＋レシート＋青い読み取り線（Gemini で生成）。1024×1024 PNG・**透過なし**・角丸なし＝`ios/App/App/Assets.xcassets/AppIcon.appiconset/AppIcon-512@2x.png`。Android も同日に差し替えた（適応アイコンの前景は**中央75%に寄せた別画像**＝108dp のうち見えるのは中央72dpのため） |
