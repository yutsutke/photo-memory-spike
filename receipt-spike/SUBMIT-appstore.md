...
| アプリアイコン | ✅ **2026-08-18 差し替え** | 暗い背景＋レシート＋青い読み取り線（Gemini で生成）。1024×1024 PNG・**透過なし**・角丸なし＝`ios/App/App/Assets.xcassets/AppIcon.appiconset/AppIcon-512@2x.png`。⚠ **Android はまだ Capacitor の初期アイコン**（青い×）＝Play に出す前に差し替える |
